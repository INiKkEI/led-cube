...
LED Cube is an 8×8×8 monochrome LED cube project designed as a documented electronics and embedded systems portfolio project. The first version uses a single ESP32-based controller PCB in the base, drives the cube through multiplexed scanning, is powered from 5 V through USB-C, and includes firmware for refresh control, preloaded animations, and serial debugging.
