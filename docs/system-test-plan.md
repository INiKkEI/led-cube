...
| ST-20 | Switch the cube on and off 10 times, watching whether the adapter cuts out or the cube fails to start. | Starts normally every time, and the adapter never shuts down. | |
...
| ST-29 | Straightedge across the top layer, measure the sag in the middle. | 2 mm or less. | |
| ST-30 | Measure a few LED spacings, carry the cube 10 m by its base, then measure the same ones again. | No spacing changed by more than 1 mm. | |
