...
| SPEC-11 | REQ-06 | Delay between column data and layer select becoming valid | 0 | exact — one latch edge |
...
| SPEC-34 | REQ-18 | Disassembly steps needed to reflash firmware | 0 | exact |
| SPEC-35 | REQ-18 | Time to flash new firmware | 60 s | maximum |
| SPEC-36 | REQ-19 | Files changed to add one animation | 2 | maximum |
| SPEC-37 | REQ-19 | Lines changed outside the animation module | 0 | exact |
| SPEC-38 | REQ-20 | Temperature of any surface a user would normally touch | 45 °C | maximum |
| SPEC-39 | REQ-20 | Ambient temperature when that measurement is taken | 25 °C | ±3 °C |
| SPEC-40 | REQ-21 | Wire or lead protruding beyond a solder joint | 1 mm | maximum |
| SPEC-41 | REQ-21 | Radius of any exposed edge or corner | 0.5 mm | minimum |
| SPEC-42 | REQ-22 | Total parts cost, excluding shipping, tools and the adapter | 100.00 EUR | maximum |
